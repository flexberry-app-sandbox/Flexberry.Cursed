...
namespace IIS.Cursed
{
    ...
    public class Накладная : IIS.Cursed.Документ
    {
        ...
        private IIS.Cursed.СостояниеНакладной fСтатус;
        
        private string fФИОПолучателя;
        
        private IIS.Cursed.Сотрудник fСотрудник;
        
        private IIS.Cursed.DetailArrayOfЗаписьВНакладной fЗаписьВНакладной;
        ...
        public virtual IIS.Cursed.СостояниеНакладной Статус
        {
            get
            {
                ...
                IIS.Cursed.СостояниеНакладной result = this.fСтатус;
        ...
        public virtual IIS.Cursed.DetailArrayOfЗаписьВНакладной ЗаписьВНакладной
        {
            get
            {
                ...
                {
                    this.fЗаписьВНакладной = new IIS.Cursed.DetailArrayOfЗаписьВНакладной(this);
                }
                IIS.Cursed.DetailArrayOfЗаписьВНакладной result = this.fЗаписьВНакладной;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НакладнаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяE", typeof(IIS.Cursed.Накладная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НакладнаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяL", typeof(IIS.Cursed.Накладная));
                }
            }
        }
    }
