...
namespace IIS.Cursed
{
    ...
    public class СтрокаЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Cursed.Заказ fЗаказ;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Cursed.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.Cursed.Заказ Заказ
        {
            get
            {
                ...
                IIS.Cursed.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СтрокаЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СтрокаЗаказаE", typeof(IIS.Cursed.СтрокаЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСтрокаЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Cursed.DetailArrayOfСтрокаЗаказа members)

        // *** End programmer edit section *** (IIS.Cursed.DetailArrayOfСтрокаЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfСтрокаЗаказа(IIS.Cursed.Заказ fЗаказ) : 
                base(typeof(СтрокаЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.Cursed.СтрокаЗаказа this[int index]
        {
            get
            {
                return ((IIS.Cursed.СтрокаЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Cursed.СтрокаЗаказа dataobject)
        {
