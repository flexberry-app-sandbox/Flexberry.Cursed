...
namespace IIS.Cursed
{
    ...
    public class ЗаписьВНакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Cursed.Накладная fНакладная;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Cursed.Накладная.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Накладная"})]
        public virtual IIS.Cursed.Накладная Накладная
        {
            get
            {
                ...
                IIS.Cursed.Накладная result = this.fНакладная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьВНакладнойE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьВНакладнойE", typeof(IIS.Cursed.ЗаписьВНакладной));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЗаписьВНакладной : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Cursed.DetailArrayOfЗаписьВНакладной members)

        // *** End programmer edit section *** (IIS.Cursed.DetailArrayOfЗаписьВНакладной members)
        ...
        /// </summary>
        public DetailArrayOfЗаписьВНакладной(IIS.Cursed.Накладная fНакладная) : 
                base(typeof(ЗаписьВНакладной), ((ICSSoft.STORMNET.DataObject)(fНакладная)))
        {
        }
        
        public IIS.Cursed.ЗаписьВНакладной this[int index]
        {
            get
            {
                return ((IIS.Cursed.ЗаписьВНакладной)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Cursed.ЗаписьВНакладной dataobject)
        {
