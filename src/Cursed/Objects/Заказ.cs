...
namespace IIS.Cursed
{
    ...
    public class Заказ : IIS.Cursed.Документ
    {
        ...
        private IIS.Cursed.СостояниеЗаказа fСтатус;
        
        private IIS.Cursed.Сотрудник fСотрудник;
        
        private IIS.Cursed.DetailArrayOfСтрокаЗаказа fСтрокаЗаказа;
        ...
        public virtual IIS.Cursed.СостояниеЗаказа Статус
        {
            get
            {
                ...
                IIS.Cursed.СостояниеЗаказа result = this.fСтатус;
        ...
        public virtual IIS.Cursed.DetailArrayOfСтрокаЗаказа СтрокаЗаказа
        {
            get
            {
                ...
                {
                    this.fСтрокаЗаказа = new IIS.Cursed.DetailArrayOfСтрокаЗаказа(this);
                }
                IIS.Cursed.DetailArrayOfСтрокаЗаказа result = this.fСтрокаЗаказа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказE", typeof(IIS.Cursed.Заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказL", typeof(IIS.Cursed.Заказ));
                }
            }
        }
    }
