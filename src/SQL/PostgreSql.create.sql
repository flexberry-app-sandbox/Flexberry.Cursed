...
CREATE TABLE ApplicationLog (
 ...
 ALTER TABLE Этаж ADD CONSTRAINT FKd18aebe4592af4b86e51a6f40815dffd8c0c2a53 FOREIGN KEY (Ряд) REFERENCES Ряд; 
CREATE INDEX Indexd18aebe4592af4b86e51a6f40815dffd8c0c2a53 on Этаж (Ряд); 

 ALTER TABLE Ячейка ADD CONSTRAINT FK51f1bb7f5712d2480d392a62c2629278224c6528 FOREIGN KEY (Этаж) REFERENCES Этаж; 
CREATE INDEX Index51f1bb7f5712d2480d392a62c2629278224c6528 on Ячейка (Этаж); 
...
CREATE INDEX Indexe97f9c6950a83008d03928b4a97ffb73e3dd3fa3 on ТоварНаСкладе (Товар); 
 ...
 ALTER TABLE ТоварНаСкладе ADD CONSTRAINT FKfa53e2002dc76e414ebe1dd58c4c9dc8f1b97269 FOREIGN KEY (Ячейка) REFERENCES Ячейка; 
CREATE INDEX Indexfa53e2002dc76e414ebe1dd58c4c9dc8f1b97269 on ТоварНаСкладе (Ячейка); 
